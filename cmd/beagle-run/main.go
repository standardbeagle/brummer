...
import (
	...
	"github.com/beagle/beagle-run/internal/mcp"
	"github.com/beagle/beagle-run/internal/process"
	"github.com/beagle/beagle-run/internal/tui"
...
var rootCmd = &cobra.Command{
	...
	Long: `Beagle Run is a terminal user interface for managing package.json scripts.
