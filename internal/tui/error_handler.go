...
// ProcessStartContext creates an error context for process starting
func ProcessStartContext(processName, component string, logStore LogStoreInterface, updateChan chan tea.Msg) ErrorContext {
	return ErrorContext{
